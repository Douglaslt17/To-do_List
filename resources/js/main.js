const data = (localStorage.getItem("todoList")) ? JSON.parse(localStorage.getItem("todoList")): { todo: [], completed: [] };

//Icones de Completado e Remover em SVG
...
//Usuário clicou no botão de adicionar
//Se tiver algum texto no input, adicionar a "todo list"
...
//Adiciona um novo item na lista de afazeres
function addItemToDOM(text, completed) {
    ...
    //Adicionando uma função de click para remover uma atividade
    ...
    //Adicionando uma função de click para completar uma atividade
